                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="custom-card">
                                ...
                                <form action="assets/php/register.php" name="register-form" method="POST">
                                    ...
                                    <p class="register-link text-center mt-3">¿Ya tienes una cuenta? <a href="login.html">Inicia Sesión</a></p>
                                </form>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="messageModalLabel">Mensaje de Registro</h5>
